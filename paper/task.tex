...
\shusen{
The primary motivation for designing the proposed tool is the error analysis challenges faced by our long-term collaborators working on natural language inference research. During the entire design and development process, we worked closely with two NLP experts via weekly meetings in a period of roughly six month (however, our previous collaborations extends well beyond this period), their constant evaluation and feedback have helped shape the tool we see today.
}
...
During our long-term collaboration with two NLP experts, we have conducted extensive discussions to understand the common approach employed by researchers for assessing the behavior of a model.% as well as provide feedback on the various prototyping stages of the proposed visualization.%
...
In Section~\ref{sec:caseStudy}, we will discussion in detail how we can use the proposed tool to address these tasks. The application Senarios 1,2,3 corresponds to \textbf{T1-T3}, respectively.
