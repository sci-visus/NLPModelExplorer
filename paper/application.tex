...
For example the sentence pair (\emph{H}: ``A couple is taking a break from bicycling.'', \textbf{H}: ``sisters sit next to their bikes.''). The word \textbf{take} and \textbf{next} should not align with each other,
