...
The proposed tool introduces a perturbation-driven visual analytics enviroment, where the domain experts can study how changes in sentence input, attention, or prediction affect each other, which helps them develop deeper intuitive and alternative hypotheses.
