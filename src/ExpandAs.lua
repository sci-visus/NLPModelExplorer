...
-- from https://github.com/Element-Research/rnn/blob/master/ExpandAs.lua
--    the luarocks install rnn failed to direct this module to include path, so include it manually here
