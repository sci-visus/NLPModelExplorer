...
\begin{abstract}
Neural networks models have gained unprecedented popularity in natural language processing due to their state-of-the-art performance and the straightforward end-to-end training scheme. Despite their advantages, the lack of interpretability hinders the further development and refinement of the model.
%
...
%
In this work, we present a flexible visualization library for creating customized visual analytic environments, which enables the user to investigate and interrogate the relationship among the input, the model internals, and the output predictions that in turn shed light on the model decision making processing.
